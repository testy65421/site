...
void 0 !== e.options.cloudpayments && t.initCloudpayments(e.options.cloudpayments)), 
...
initPaysky: function(t) {
var a = this, o = t.configure, i = $("#method"), e = $("button[type=submit]", a.fieldsContainer), n = $("<button />", o).hide();
e.after(n), e.on("click", function(e) {
if (i.val() == t.type) {
e.stopImmediatePropagation();
var n = a.fieldsContainer.serializeArray();
n.push({
name: "save",
value: !0
});
...
i(), a = e.data.qr_code, a = "data:image/png;base64," + a, t.prop("src", a)) : "error" == e.status && (e = e.error && e.error.length ? e.error : n.defaultErrorText, 
i(), e && e.length && o.fieldsContainer.prepend(templates["addfunds/alert"]({
text: e
})));
}
...
method: "POST",
success: function(a) {
"success" == a.status && new cp.CloudPayments().pay("charge", {
publicId: a.data.publicId,
amount: Number(a.data.amount),
...
t = $("#orderform-service").val(), void 0 !== e ? n.updateFields(e, !1, n.services[t].link_type) : n.updateFields(0, !1, 0), 
...
/*
     FILE ARCHIVED ON 00:19:22 Feb 12, 2022 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 09:42:38 Mar 17, 2022.
...
/*
playback timings (ms):
  captures_list: 1140.454
  exclusion.robots: 0.218
  exclusion.robots.policy: 0.21
  RedisCDXSource: 0.66
  esindex: 0.008
  LoadShardBlock: 1120.959 (3)
  PetaboxLoader3.datanode: 1198.127 (5)
  CDXLines.iter: 15.823 (3)
  load_resource: 314.557 (2)
  PetaboxLoader3.resolve: 75.344 (2)
*/
